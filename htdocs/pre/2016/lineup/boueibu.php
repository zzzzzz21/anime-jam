<?php
define("PAGE_TITLE", "美男高校地球防衛部LOVE! LOVE!｜LINE UP");
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . "/2016/include/html/header_nav.php"); ?>
	...
	<div id="contents">
		...
		<!-- 作品詳細 -->
		<div class="programCol p_rock" id="p_binan">
			<div id="programInfo" class="clearfix">
				<div class="picArea">
					<img src="../common/images/img_slideRock04.jpg" alt="美男高校地球防衛部LOVE! LOVE!">
					<div class="btnOfficial"><a href="http://boueibu.com/" target="_blank"></a></div>
				</div>
				<div class="story txtArea">
					...
					<p>
						北関東某所・眉難市……<br>
						<br>
						眉難高校の「地球防衛部」は、ひょんなことから<br>
						バトルラヴァーズにラブメイキング（変身）して<br>
						征服部が繰り出す怪人と戦うことに。<br>
						<br>
						バトラヴァ活動もはや半年。<br>
						テレビ宇宙の放送する番組のせいで征服部と戦わされていたことが判明、<br>
						和解した防衛部と征服部が力を合わせ、<br>
						黒幕の番組ディレクターを倒し、無事打ち切りに。<br>
						<br>
						これで戦うことも無くなったよね！と高校生活を満喫しようと、<br>
						いつもの黒玉湯でお湯につかっていると……
					</p>
				</div>
			...
			<div id="live">
				...
				<img src="../common/images/lineup_binan_live.jpg" width="400" height="300" alt="LIVE">
				<p>VEPPer 別府月彦（CV河本啓佑）、別府日彦（CV村上喜紀）</p>
			</div>
