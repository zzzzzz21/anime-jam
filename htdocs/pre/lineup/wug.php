<?php
define("PAGE_TITLE", "Wake Up, Girls！｜LINE UP");
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . "/include/html/header_nav.php"); ?>
	...
	<div id="contents">
		...
		<!-- 作品詳細 -->
		<div class="programCol p_pop" id="p_wug">
			<div id="programInfo" class="clearfix">
				<div class="picArea">
					<img src="../common/images/img_slidePop06.jpg" alt="Wake Up, Girls！">
					<div class="btnOfficial"><a href="http://wug-portal.jp/" target="_blank"></a></div>
				</div>
				<div class="story txtArea">
					...
					<p>
						時はアイドル戦国時代。<br>
						これは、この荒波を生き抜く<br>
						７人の少女達「Wake Up, Girls！」の物語である。<br>
						<br>
						東北・仙台にある廃業寸前の弱小プロダクション、<br>
						グリーンリーヴズ・エンタテインメント。<br>
						<br>
						かつては手品師、グラビアアイドル、占い師などが所属していたが、<br>
						唯一活動していた最後のタレントもついに辞めてしまう。<br>
						<br>
						所属タレント０（ゼロ）という危機的状況の中、<br>
						事務所社長・丹下の思い付きで<br>
						アイドルユニットをプロデュースする事を決意する。<br>
						傍若無人な社長の元、マネージャー松田は不満を持ちながらも、<br>
						アイドルの原石を探しに街へ出る。<br>
						そんな中、マネージャー松田は、ある少女と必然的な出会いを果たし・・・。<br>
						<br>
						がんばっぺ！Wake Up, Girls！
					</p>
				</div>
				<div class="staff txtArea">
					...
					<dl>
						<dt>STAFF</dt>
						<dd>原作・脚本： Green Leaves</dd>
						<dd>原案・監督：山本寛</dd>
						<dd>キャラクターデザイン：近岡直</dd>
						<dd>音楽：神前暁　MONACA</dd>
						<dd>アニメーション制作：Ordet × ミルパンセ</dd>
						<dt>CAST</dt>
						<dd>島田真夢：吉岡茉祐</dd>
						<dd>林田藍里：永野愛理</dd>
						<dd>片山実波：田中美海</dd>
			...
			<div id="live">
				...
				<img src="../common/images/lineup_wug_live.jpg" width="400" height="300" alt="LIVE">
				<p>Wake Up, Girls!</p>
			</div>
