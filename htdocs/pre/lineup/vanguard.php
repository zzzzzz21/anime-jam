<?php
define("PAGE_TITLE", "LINE UP｜ヴァンガード　ストライドゲート");
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . "/include/html/header_nav.php"); ?>
	...
	<div id="contents">
		...
		<!-- 作品詳細 -->
		<div class="programCol p_rock" id="p_vg">
　			<div id="programInfo" class="clearfix">
				<div class="picArea">
					<img src="../common/images/img_slideRock03.jpg" alt="ヴァンガード　ストライドゲート">
					<div class="btnOfficial"><a href="http://www.tv-tokyo.co.jp/anime/cf-vanguard-g2/index2.html" target="_blank"></a></div>
				</div>
				<div class="story txtArea">
					<h3><span>STORY</span></h3>
					<p>
						トライスリーの物語はNEXTへ！<br>
						若きヴァンガードファイター達が集う<br>
						超大型大会U20チャンピオンシップが開催！<br>
						高校生になったトライスリーの新導クロノ、綺場シオン、安城トコハは<br>
						それぞれの未来を掴む為に別々のチームを結成し、<br>
						U20チャンピオンシップでライバルとして激突する！
					</p>
				</div>
				<div class="staff txtArea">
					...
					<dl>
						<dt>STAFF</dt>
						<dd>製作総指揮・原案：木谷 高明</dd>
						<dd>原作：ブシロード</dd>
						<dd>伊藤 彰（「月刊ブシロード」連載中)</dd>
						<dd>監督：川崎 逸朗</dd>
						<dd>シリーズ構成：吉村 清子</dd>
						<dd>カードファイト構成：中村 聡（遊宝洞）</dd>
						<dd>キャラクターデザイン：磯野 智</dd>
						<dd>アニメーション制作：OLM</dd>
						<dt>CAST</dt>
						<dd>新導クロノ：石井マーク</dd>
						<dd>綺場シオン：榎木淳弥</dd>
			...
			<div id="live">
				...
				<p>ラミーラビリンス＜アム(CV.愛美)・ルーナ(CV.工藤 晴香)＞</p>
			</div>
