	...
	(function (root) {
		var VerticalSlider = (function () {
			...
			VerticalSlider.prototype.cacheElements = function cacheElements() {
				...
				this.targetList = ['main00', 'main01','main04','main02', 'main05','main03' , 'main06', 'main07', 'main08', 'main01','main09','main02', 'main10','main03' , 'main11'];
				this.current = 0;
				this.sliderTimer = 0;
				this.directive = true;
				this._clickflg = true;
				...
				function slideNext() {
					...
					if (_this.current == 0) {
						...
						$('.mod-sliderTicketLink').velocity({"opacity":0},{duration:500,easing:'easeInOutCubic',
							...
							$('.mod-sliderTicketLink').css({"top":"70%","bottom":"auto","left":"0","margin-left":"10%"}).velocity({"opacity":1},{duration:500,easing:'easeInOutCubic'})
							}
						})
					} else {
						$('.mod-sliderTicketLink').velocity({"opacity":0},{duration:500,easing:'easeInOutCubic',
							...
							$('#mod-sliderTicketBtn1').css({'display':'none'})
							$('#mod-sliderTicketBtn2').css({'display':'block'})
							$('.mod-sliderTicketLink').css({"top":"70%","bottom":"auto","left":"0","margin-left":"60%"}).velocity({"opacity":1},{duration:500,easing:'easeInOutCubic'})
							}
						})
						}
