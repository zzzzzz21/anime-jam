...
<?php require_once "../include/html/header.php"; ?>
	...
	<div id="contents">
		<div class="contentsInner bgType01">
			...
			<section class="specialDetail clearfix">
				<div class="specialDetail-wrapper">
				<?php
				/* ====================================================================== */
				...
				if($xml = @simplexml_load_file($url)){
					if(isset($xml->code)){
						...
						if(isset($xml->item)){
							...
							$html .= "<div class=\"specialDetail-inner\">\n";
							$html .= "<h3 class=\"specialDetail-inner_ttl\">".$title."</h3>\n";
							$html .= "<div class=\"specialDetail-inner_text\">\n".$contents."</div>\n";
							$html .= "</div>\n";
							$html .= "</div>\n";
 ...
 */
			...
			<a href="../special/" class="specialDetail-btn">
				<img src="../common/images/special-detail_btn.png" alt="SPECIAL一覧へ">
			</a>
		</div>
	</div>
	<!-- ▲ contents -->
