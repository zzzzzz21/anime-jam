				...
				<li>
					...
					<p class="info-list_text">
						<span class="text__schedule">
							<em>一般発売（先着順）</em><br>
							※インターネット販売、店頭販売のみ（電話受付なし）<br>
							・販売開始：11/11（土）午前10:00～<br>
							※予定枚数に達し次第、終了<br>
							・受付方法：WEB予約・購入　（URL　<a href="http://w.pia.jp/t/animejam-lv/" target="_blank">http://w.pia.jp/t/animejam-lv/</a>）<br>
​							もしくは　セブン-イレブン、サークルKサンクス、ぴあ店舗　各店頭直接購入<br>
							・決済方法（WEB）：セブン-イレブン決済/ファミリーマート決済/サークルK・サンクス・ぴあ店舗/イーコンテクスト決済/クレジットカード決済<br>
							・引取方法（WEB）：全国のセブン-イレブン、ファミリーマート、サークル K・サンクス、チケットぴあ店舗、配送引取<br>
							・枚数制限：お一人様4枚まで<br>
							・手数料：発券手数料108円/枚・システム利用料216円/枚<br>
​							※WEB購入のみ・決済手数料216円/件※WEB購入のみ、クレジットカード決済の場合不要<br>
							※WEB購入時は事前にチケットぴあ無料会員登録が必要となります。<br>
							※入金期間に入金されなかった場合は無効となりますのでご注意ください。<br>
							※WEB購入時に配送引取を選択の場合、1件につき配送料617円がかかります。<br>
							その際発券手数料108円/1枚は発生いたしません。<br>
					</p>
				</li>
				<li>
					<h3 class="info-list_ttl">
